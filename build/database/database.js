...
class DataBase {
    ...
    constructor() {
        this._cadenaConexion = 'mongodb+srv://alvaro:123@cluster0.e2jny.mongodb.net/Trenes?retryWrites=true&w=majority';
        ...
        this.cambiarBD = (a) => __awaiter(this, void 0, void 0, function* () {
            if (a == false) {
